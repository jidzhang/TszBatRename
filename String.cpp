...
//CString TR(UINT nID) {
//	VMProtectBegin("TR_nID");
//	CString str;
//#ifdef _UNICODE
//	str = String::LoadString(nID);
//	wchar_t * buffer = VMProtectDecryptStringW(str.GetBuffer());
//	str.ReleaseBuffer();
//	str = buffer;
//	VMProtectFreeString(buffer);
//#else
//	str = String::LoadString(nID);
//	char * buffer = VMProtectDecryptStringA(str.GetBuffer());
//	str.ReleaseBuffer();
//	str = buffer;
//	VMProtectFreeString(buffer);
//#endif
...
//	return str;
//}
//CString TR(CString str) {
//	VMProtectBegin("TR_str");
//#ifdef _UNICODE
//	wchar_t * buffer = VMProtectDecryptStringW(str.GetBuffer());
//	str.ReleaseBuffer();
//	str = buffer;
